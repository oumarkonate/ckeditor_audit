...
Returns which files reference a given plugin, and whether those references
...
class FindUsagesReport(BaseModel):
    """Result of find_usages: matched files and token savings metadata."""

    usages: list[FileUsage]
    token_savings: TokenSavings


def find_usages(plugin: str) -> FindUsagesReport:
    """
    Return the list of files that reference the given CKEditor plugin.
